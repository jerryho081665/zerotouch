# ZeroTouch.UI &mdash; Attributions

<br>

This document lists all external icons and audio assets used in this project, grouped by source.  
All assets remain the property of their respective authors and are used according to their stated licenses.
...
| Asset | Source | Author / Uploader | License |
|-------|--------|-------------------|---------|
| **Home Icon** | https://www.svgrepo.com/svg/427809/home | SVG Repo | CC0 License (Public Domain) |
| **Phone Icon** | https://www.svgrepo.com/svg/526086/phone | Solar Icons | CC Attribution License |
...
|------|--------|--------|---------|
| **Google Maps Icon** | <a href="https://www.flaticon.com/free-icons/google-maps" title="google maps icons">Google maps icons created by Freepik - Flaticon</a> | Freepik | Flaticon License |
| **Play Button Icon** | <a href="https://www.flaticon.com/free-icons/play" title="play icons">Play icons created by Freepik - Flaticon</a> | Freepik | Flaticon License |
| **Pause Button Icon** | <a href="https://www.flaticon.com/free-icons/pause" title="pause icons">Pause icons created by Chanut - Flaticon</a> | Chanut | Flaticon License |
| **Next Button Icon** | <a href="https://www.flaticon.com/free-icons/next" title="next icons">Next icons created by Azland Studio - Flaticon</a> | Azland Studio | Flaticon License |
| **Previous Button Icon** | <a href="https://www.flaticon.com/free-icons/next" title="next icons">Next icons created by Azland Studio - Flaticon</a> | Azland Studio | Flaticon License |
...
| **Romantic_Inspiration.mp3** | FreePD (https://freepd.com/) | Rafael Krux | Creative Commons 0 (CC0) - Public Domain |
| **Pond.mp3** | FreePD (https://freepd.com/) | Rafael Krux | Creative Commons 0 (CC0) - Public Domain |
